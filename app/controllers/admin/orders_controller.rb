class Admin::OrdersController < AdminController
  ...
  def update
    respond_to do |format|
      if @admin_order.update(admin_order_params)
        format.html { redirect_to admin_orders_path(@admin_order), notice: "Order was successfully updated.", status: :see_other }
  ...
  private
    ...
    def admin_order_params
      params.expect(order: [ :customer_email, :fullfiled, :total, :address ])
    end
end
